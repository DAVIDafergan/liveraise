  ...
  return (
    <div className="live-container" dir="rtl" style={screenStyles}>
      <style>{`
        ...
        .total-label { 
          color: #d4af37; font-weight: 900; font-size: 2.2rem; letter-spacing: 5px; 
          margin-bottom: 10px; 
          border-bottom: 2px solid rgba(212, 175, 55, 0.6); padding-bottom: 10px; 
